...
import { Home, ArrowLeft, LogIn, Key } from 'lucide-react';
...
const Unauthorized = () => {
  ...
  return (
    <>
      <Helmet>
        <title>401 - No Autorizado | Witar</title>
        <meta name="description" content="Debes iniciar sesión para acceder a esta página." />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Key className="w-24 h-24 md:w-32 md:h-32 text-primary/40" />
              </div>
            </motion.div>
