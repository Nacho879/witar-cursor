...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Witar - Gestión de Recursos Humanos',
        short_name: 'Witar',
        description: 'La plataforma más completa para la gestión de recursos humanos. Simplifica el control horario, vacaciones y documentos laborales.',
        theme_color: '#3B82F6',
        ...
        shortcuts: [
          {
            name: 'Fichaje',
            short_name: 'Fichaje',
            description: 'Acceso rápido al fichaje',
            url: '/timeclock',
