...
export default function ManagerDashboard() {
  ...
  async function loadRecentRequests(companyId, managerId) {
    try {
      ...
      if (teamUserIds.length > 0) {
        // Cargar solicitudes normales del equipo - solo campos necesarios y limitadas
        ...
        // Cargar solicitudes de edición de fichajes del equipo - solo campos necesarios y limitadas
