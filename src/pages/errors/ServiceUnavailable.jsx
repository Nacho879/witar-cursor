...
import { Home, ArrowLeft, RefreshCw, Wrench, Clock } from 'lucide-react';
...
const ServiceUnavailable = () => {
  ...
  return (
    <>
      <Helmet>
        <title>503 - Servicio No Disponible | Witar</title>
        <meta name="description" content="El servicio está temporalmente no disponible. Estamos realizando mantenimiento." />
      </Helmet>
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Wrench className="w-24 h-24 md:w-32 md:h-32 text-primary/40" />
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeIn}>
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-2">
                Estamos realizando mantenimiento programado.
              </p>
              <p className="text-base text-muted-foreground">
                El servicio estará disponible nuevamente en breve. Gracias por tu paciencia.
              </p>
            </motion.div>
